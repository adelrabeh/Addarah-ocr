...
export default function JobsPage() {
  ...
  // Auto-refresh the jobs list whenever a progress event arrives for a processing job
  useEffect(() => {
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          ...
                          {job.status === "processing" && (() => {
                            ...
                            if (prog && prog.totalPages > 0) {
                              const pct = Math.round((prog.processingPage / prog.totalPages) * 100);
                              return (
                                <div className="mt-1.5 min-w-32">
                                  <Progress value={pct} className="h-1.5" />
                                  <p className="text-xs text-blue-600 mt-0.5">
                                    الصفحة {prog.processingPage} من {prog.totalPages} ({pct}%)
                                  </p>
                                </div>
                              );
                            }
